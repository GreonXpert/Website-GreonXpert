      ...
      <Container maxWidth="xl" sx={{ position: 'relative', zIndex: 1 }}>
        ...
        <Fade in timeout={1500}>
          ...
          >
            ...
            >
              Join innovative companies transforming their environmental impact with our interactive Climate Intelligence platform featuring cutting-edge 3D visualization
            </Typography>
            <Box sx={{ 
              display: 'flex', 
              gap: 4, 
